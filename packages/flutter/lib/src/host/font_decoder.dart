// Derived from woff2 0.1.0 (Apache-2.0, copyright 2026 Denis Nadey).
// See THIRD_PARTY_NOTICES.md for the retained license and modification notice.
// Uses pure Dart Brotli without requiring host-specific native FFI deployment.
...
/// WOFF2 uses the pure Dart `brotli` decoder. The WOFF2
