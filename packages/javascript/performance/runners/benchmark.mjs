...
const RESULTS_ROOT = path.join(WORKSPACE_ROOT, '.artifacts/performance/benchmark');
...
async function main() {
  ...
  summary.rawArtifact = {
    path: path.relative(WORKSPACE_ROOT, path.join(options.resultsRoot, rawFilename)),
    sha256: rawDigest,
