import type { ParsePatchMapResult, PatchMapComponentVisualProjection, PatchMapProjectionIndex, PatchMapTextProjection } from '../parsing/contracts';
...
import { patchMapEntityWorldAabb } from '../geometry/entity-hit-index';
