...
class MutationSurface extends SurfaceBase {
  ...
  public readonly diagnostics: PatchMapReconcileDiagnostic[] = [];
...
describe('PatchMap authoritative semantic mutation', () => {
  ...
  it('reports the rendered rotated AABB in world and screen geometry', () => {
    ...
    const geometry = createPatchMapSurfaceGeometrySnapshot(snapshot);
...
function readCaption(engine: PatchMap) {
