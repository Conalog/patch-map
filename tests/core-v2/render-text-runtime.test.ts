...
import {
  CORE_V2_RENDER_TEXT_CLEANUP_REVISION,
  CORE_V2_RENDER_TEXT_RUNTIME_REVISION,
  createCoreV2RenderTextRuntime,
} from '../../lab/performance-v2/contract/render-text-runtime';
...
describe('Core v2 REN-006 / REN-011 expected-blind runtime', () => {
  it('owns only independent specimens and zero external font or transport resources', () => {
    const runtime = createCoreV2RenderTextRuntime('REN-011');
...
class HeadlessTextRenderer {
  ...
  public textRendererProbe(entityId: string): CoreV2TextRendererProbe | null {
    ...
    const semanticSignatures: CoreV2TextSemanticSignatures = Object.freeze({
...
function sameAttachedSignatures(
  attached: CoreV2TextAttachedSignatures | null,
  rendered: CoreV2TextAttachedSignatures | null,
): boolean {
  return attached !== null
    && rendered !== null
