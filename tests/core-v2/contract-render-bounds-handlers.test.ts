...
describe('Core v2 LAY-005 render-bounds actual-only handlers', () => {
...
class BoundsSurface implements CoreV2EngineSurface {
  ...
  public geometrySnapshot(): CoreV2SurfaceGeometrySnapshot {
    ...
    }) as unknown as CoreV2SurfaceGeometrySnapshot;
  }
...
function contains(bounds: Bounds, point: CoreV2Point): boolean {
