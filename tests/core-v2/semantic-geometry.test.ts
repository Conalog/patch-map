...
import { projectCoreV2SignedRect } from '../../src/core-v2/semantic/geometry';

describe('Core v2 signed rectangular projection', () => {
  it('encodes a horizontal flip as the equivalent positive dense footprint', () => {
    const projection = projectCoreV2SignedRect(
  ...
  it('rejects non-finite transforms and invalid local sizes', () => {
    expect(() => projectCoreV2SignedRect(
