...
class ComponentAssetRendererDouble {
  ...
  private paintProbes = new Map<string, CoreV2EntityPaintProbe>();
...
describe('Core v2 component asset product/controller', () => {
...
async function createHarness(
  ...
  instanceId: string,
): Promise<Readonly<{ engine: CoreV2Engine; renderer: ComponentAssetRendererDouble }>> {
...
async function runIconTrace(
  ...
  probe: ReturnType<CoreV2Engine['componentVisualProbe']>;
...
class LegacySurface implements CoreV2EngineSurface {
