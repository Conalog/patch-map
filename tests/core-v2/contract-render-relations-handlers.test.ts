...
import {
  ...
  type CoreV2Point,
  type CoreV2RelationHit,
  type CoreV2RelationHitOptions,
...
describe('Core v2 REN-007 render-relations actual-only handlers', () => {
...
class RelationSurface implements CoreV2EngineSurface {
