...
const RENDER_LANE_ROLES: readonly CoreV2RenderLaneRole[] = [
  'background-geometry',
  'background-assets',
  'ordinary-geometry',
  'relations-dynamic',
...
function renderLanes(): CoreV2RenderLaneSnapshot {
  const lanes = Object.create(null) as Record<
    CoreV2RenderLaneRole,
    CoreV2RenderLaneSnapshot[CoreV2RenderLaneRole]
  >;
...
class PixiProbeSurface implements CoreV2EngineSurface {
  public canvasCount = 1;
  public destroyed = false;
  public lossState: PixiCoreV2RendererLossProbe['state'] = 'healthy';
  ...
  public componentVisualProbe(): CoreV2SurfaceComponentVisualProbe {
    return Object.freeze({
...
function createProbeEngine(): Readonly<{
  ...
  const factory: CoreV2EngineSurfaceFactory = (next) => {
    options.push(next);
    return Promise.resolve(surface);
  };
  return Object.freeze({
    engine: new CoreV2Engine({ surfaceFactory: factory }),
    options,
    surface,
  });
}

describe('Core v2 public PixiJS product probes', () => {
