...
import type { CoreV2Element } from '../../src/core-v2/semantic/dataset';

class TransformerSurface implements CoreV2EngineSurface {
  public canvasCount = 1;
  public destroyed = false;
  public loaded: readonly CoreV2Element[] = Object.freeze([]);
...
describe('CoreV2Engine transformer edit integration', () => {
...
): Promise<Readonly<{ engine: CoreV2Engine; surface: TransformerSurface }>> {
...
function beginMovePreview(engine: CoreV2Engine, pointerId: number): void {
  engine.beginTransformerEdit({
    pointerId,
