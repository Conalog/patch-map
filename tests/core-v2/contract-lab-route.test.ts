...
describe('Core v2 focused contract Lab presenters', () => {
  ...
  it('materializes only exact selected fixtures, actions, size, and seed without expected evidence', () => {
    expect(CORE_V2_EXECUTABLE_ACTION_DEFINITIONS).toHaveLength(136);
    expect(CORE_V2_EXECUTABLE_CASE_IDS).toHaveLength(67);
    expect(CORE_V2_CONTRACT_STUB_COUNT).toBe(106);
