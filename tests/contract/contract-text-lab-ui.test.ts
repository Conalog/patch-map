...
import { renderPatchMapContractLab } from '../../lab/contract/main';
import { parsePatchMapContractRoute } from '../../lab/contract/route';

const mainUrl = new URL('../../lab/contract/main.ts', import.meta.url);
const textInspectorUrl = new URL(
  '../../lab/contract/inspectors/text-inspector.ts',
  import.meta.url,
);
const runObserverUrl = new URL(
  '../../lab/contract/run-observer.ts',
  import.meta.url,
);
