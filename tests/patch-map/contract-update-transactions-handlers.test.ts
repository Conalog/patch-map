...
import {
  PatchMap,
  type PatchMapEngineSceneImageRecord,
  type PatchMapEngineSceneImagesProbe,
...
class UpdateContractSurface implements PatchMapEngineSurface {
...
function createTestAssetRuntime(): PatchMapAssetRuntime {
