...
describe('PatchMap host interaction substrate', () => {
  ...
  it('blocks editor plants before allocating an Engine or canvas', () => {
    ...
    expect(() => resolvePatchMapEditorMount(null as unknown as boolean)).toThrow(
  ...
  it('owns one interaction mode stack with temporary and blur cleanup', async () => {
    ...
    const apply = (operation: Parameters<
      PatchMap['applyInteractionModeOperation']
    >[0]) => {
...
class HostInteractionSurface implements PatchMapEngineSurface {
