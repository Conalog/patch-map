...
import { runPatchMapManualAdvancedAction } from '../../lab/interactive/manual-workbench-actions';
import {
...
} from '../../lab/interactive/manual-workbench-cleanup';
import {
  PatchMapManualPointerController,
  type PatchMapManualPointerOutcome,
} from '../../lab/interactive/manual-pointer-controller';
import {
  angleDegrees,
  canvasPoint,
  cursorForMode,
