...
npx vitest run --maxWorkers=2 tests/patch-map/placement.test.ts tests/patch-map/text-layout.test.ts tests/patch-map/style-normalization.test.ts tests/patch-map/render-schema-support.test.ts tests/patch-map/parser.test.ts tests/patch-map/dataset-contract.test.ts
```
