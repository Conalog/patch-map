...
test('release channels support independent future versions without backward movement', () => {
  for (const [target, previous] of [['1.0.0-alpha.10', '1.0.0-alpha.9'], ['2.0.0-alpha.1', '1.9.0-rc.99'], ['1.0.0-alpha.2', '1.0.0-alpha.1'], ['1.0.0', '0.10.0'], ['1.0.0', '1.0.0-rc.9']]) {
  ...
  assert.equal(parseVersion('1.0.0-alpha.1').stable, false);
