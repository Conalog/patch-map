...
This page routes readers to the current owner of each documentation surface.
It is repository-internal and is not included in the published package.

## Package consumers

- [Public documentation](patch-map/README.md)
- [API and dataset reference](patch-map/api-and-dataset.md)
- [Host integration](patch-map/host-integration.md)
...
part of that publication surface.
