...
- The allowed inventory is 610 files / 485,641 LOC after excluding
...
- The working plan owns the 610-file disposition and T0–T10 migration map.
...
- The checkpoint passes 190 unit files / 1,696 tests, full lint/typecheck,
...
- Split the three remaining mixed contract-test composition suites along their
  existing semantic blocks without moving case assertions or comparison rules.
