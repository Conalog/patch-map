...
Core v2 may choose any API names and internal architecture, but the host must be able to
...
Core v2 owns a configurable history stack with default capacity 50 and exposes
...
PixiJS. Core v2 supplies current owner-qualified logical targets, screen/world geometry, revision stamps,
