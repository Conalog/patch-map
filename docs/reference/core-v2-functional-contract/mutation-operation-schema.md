...
This document is the mechanically implementable mutation language for Core v2. The
schema identifier is `core-v2-mutation-transaction/1`; it is carried by the host port
