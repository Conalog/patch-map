...
| Mutation and transaction publication | `src/public/mutation-*`, `src/semantic/transaction/`, `src/engine/transaction-commit-coordinator.ts` | `tests/semantic/semantic-transaction-mutations.test.ts`, `tests/engine/engine-update-transactions.test.ts` | update performance probe for changed hot paths |
...
| Editor workflows | `src/editor-workflow/`, `src/public/editor.ts` | `tests/semantic/editor-workflow.test.ts`, `tests/integration/developer-api-workflows.test.ts` | package gate |
