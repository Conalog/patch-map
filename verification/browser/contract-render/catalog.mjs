import { PATCH_MAP_CSM_DECLARED_IMMUTABLE_CONFLICTS } from '../../contract/immutable-conflicts.mjs';
...
export const RENDER_CASES = Object.freeze([
  ...
  Object.freeze({ id: 'LAY-002', expectedAssertions: 24 }),
