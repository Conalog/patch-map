...
export const LIFECYCLE_DESTROY_FOLD_REVISION = 'patch-map-lifecycle-destroy-fold/1';
...
function assert(condition, message) {
  if (!condition) throw new Error(`PatchMap lifecycle-destroy fold invalid: ${message}`);
}
