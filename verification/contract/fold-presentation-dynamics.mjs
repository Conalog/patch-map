...
export const PRESENTATION_DYNAMICS_FOLD_REVISION =
  'patch-map-presentation-dynamics-fold/1';
...
const PRODUCT_RUNTIME_REVISION = 'patch-map-presentation-dynamics-runtime/1';
const PRODUCT_CLEANUP_REVISION = 'patch-map-presentation-dynamics-cleanup/1';
...
function assert(condition, message) {
  if (!condition) throw new Error(`PatchMap presentation dynamics fold invalid: ${message}`);
}
