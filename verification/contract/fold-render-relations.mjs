...
export const RENDER_RELATIONS_FOLD_REVISION = 'patch-map-render-relations-fold/1';
...
function assert(condition, message) {
  if (!condition) throw new Error(`PatchMap render-relations fold invalid: ${message}`);
}
