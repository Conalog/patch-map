...
export const RENDER_ORIENTATION_FOLD_REVISION = 'patch-map-render-orientation-fold/1';
...
function assert(condition, message) {
  if (!condition) throw new Error(`PatchMap render-orientation fold invalid: ${message}`);
}
