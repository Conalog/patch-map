...
export const AUTHORING_FOLD_REVISION = 'patch-map-authoring-fold/1';
...
function projectCase(caseId, execution) {
  switch (caseId) {
    ...
    default:
      throw new Error(`Unsupported PatchMap authoring fold case ${String(caseId)}`);
  }
}
...
function assert(condition, message) {
  if (!condition) throw new Error(`Invalid PatchMap authoring fold: ${message}`);
}
