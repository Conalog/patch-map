...
export const LIFECYCLE_RESIZE_FOLD_REVISION = 'patch-map-lifecycle-resize-fold/1';
...
function assert(condition, message) {
  if (!condition) throw new Error(`PatchMap lifecycle-resize fold invalid: ${message}`);
}
