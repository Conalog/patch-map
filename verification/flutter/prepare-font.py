...
source = ROOT / 'packages/javascript/src/resources/fonts/FiraCode-VF.woff2'
target = ROOT / 'packages/flutter/assets/fonts/FiraCode-VF.ttf'
...
provenance = {'source': 'packages/javascript/src/resources/fonts/FiraCode-VF.woff2', 'sourceSha256': hashlib.sha256(source.read_bytes()).hexdigest(),
