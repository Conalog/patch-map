...
test('Dart artifact inventory excludes examples, tests and generated metadata', async () => {
  ...
  try {
    for (const [path, value] of Object.entries({
      'pubspec.yaml': 'name: conalog_patch_map', 'lib/conalog_patch_map.dart': 'library;',
    ...
    assert.deepEqual(await publicationFiles(directory), ['assets/icons/object.svg', 'lib/conalog_patch_map.dart', 'pubspec.yaml']);
