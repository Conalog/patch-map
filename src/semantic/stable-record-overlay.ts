export type PatchMapStableRecordStrategy = 'frozen-copy' | 'internal-overlay';
 ...
 */
export function patchPatchMapStableRecord<Value>(
 ...
 */
export function compactPatchMapStableRecord(
 ...
 */
export function rollbackPatchMapStableRecord(
...
export function isPatchMapStableRecordOverlay(value: unknown): boolean {
