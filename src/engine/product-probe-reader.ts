...
import type { PatchMapComponentRenderRole } from '../parsing/contracts';
...
import type { PatchMapPresentationLayerSnapshot } from '../core/presentation-layers';
import type { PatchMapRendererLossProbe, PatchMapRenderLaneRole } from '../rendering-port';
...
export interface PatchMapEngineProductProbeReadPort {
  ...
  pixiPublicSurfaceRead(): Readonly<{
    probe: ReturnType<
      NonNullable<PatchMapSurfaceDiagnosticsPort['rendererPublicSurfaceProbe']>
    > | null;
    canvasCount: number;
  }>;
  ...
  terminalRendererLossProbe(): PatchMapRendererLossProbe | null;
...
export function readPatchMapEngineRendererPublicSurfaceProbe(
  state: PatchMapEngineProductProbeReadPort,
): PatchMapEngineRendererPublicSurfaceProbe | null {
