...
/** Minimal renderer-aligned geometry consumed by accessibility derivation. */
export interface PatchMapAccessibilityTargetGeometry {
  readonly id: string;
...
export function derivePatchMapAccessibilityTargets(
  ...
  geometries: readonly PatchMapAccessibilityTargetGeometry[],
): PatchMapAccessibilityDerivation {
