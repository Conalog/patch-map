...
import { allowPackageBuiltinsOnly } from './assets/ingestion-policy';
import { createPatchMapPixiAssetBackend } from './assets/pixi-backend';
import {
...
} from './assets/registration-normalization';

export { PatchMapAssetError } from './assets/contracts';
export type {
...
} from './assets/ingestion-policy';
export { createPatchMapPixiAssetBackend } from './assets/pixi-backend';
export {
  PATCH_MAP_BUILTIN_ASSETS,
