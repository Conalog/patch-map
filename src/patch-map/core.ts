...
import {
  ...
  type PatchMapReconcileOptions as PatchMapDenseReconcileOptions,
 ...
 * Application.
 */
class PatchMapRendererLease implements CoreRenderer {
  private destroyedValue = false;

  public constructor(private readonly renderer: PatchMapPixiRenderer) {}
