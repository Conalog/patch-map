...
export interface PatchMapTextRenderStyle {
...
export interface PatchMapBitmapTextStyleProof {
  readonly fontFamily: string;
  readonly fontSize: number;
  readonly fontWeight: number;
  readonly fontStyle: 'normal' | 'italic' | 'oblique';
 ...
 */
export interface PatchMapBitmapTextCapabilityProof {
  readonly coverage: 'proven';
  readonly atlasId: string;
  readonly glyphs: readonly string[];
  readonly style: PatchMapBitmapTextStyleProof;
...
export interface PatchMapTextRenderRouteInput {
  ...
  readonly glyphResolution: PatchMapTextGlyphResolution;
  readonly bitmapCapability: PatchMapBitmapTextCapabilityProof | null;
}

export interface PatchMapTextRenderRouteDecision {
  readonly revision: typeof PATCH_MAP_TEXT_RENDER_ROUTE_REVISION;
  readonly route: PatchMapTextRenderRoute;
  readonly reason: PatchMapTextRenderRouteReason;
  readonly reasons: readonly PatchMapTextRenderRouteReason[];
 ...
 */
export function selectPatchMapTextRenderRoute(
  input: PatchMapTextRenderRouteInput,
): PatchMapTextRenderRouteDecision {
  validateInput(input);
  ...
  const contentWithinLimit = input.text.length <= PATCH_MAP_BITMAP_TEXT_MAX_CODE_UNITS;
...
function inspectCapability(
  proof: PatchMapBitmapTextCapabilityProof | null,
...
function styleDifference(
  style: PatchMapTextRenderStyle,
  proof: PatchMapBitmapTextStyleProof,
): string[] {
...
function validStyleProof(value: PatchMapBitmapTextStyleProof): boolean {
  return value !== null
    && typeof value === 'object'
...
function validateInput(input: PatchMapTextRenderRouteInput): void {
...
function isFontStyle(value: unknown): value is PatchMapTextRenderStyle['fontStyle'] {
