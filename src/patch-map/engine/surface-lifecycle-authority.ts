...
import type { PatchMapPixiRendererLossProbe } from '../renderers/types';
import type {
...
export interface PatchMapSurfaceCleanupResult {
  ...
  readonly rendererLoss: PatchMapPixiRendererLossProbe | null;
}
...
export class PatchMapSurfaceLifecycleAuthority<TInitialization> {
  ...
  public async cleanup(
    ...
    let rendererLoss: PatchMapPixiRendererLossProbe | null = null;
