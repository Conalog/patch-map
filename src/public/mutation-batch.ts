...
import type {
  ...
  PatchMapHostInstanceBarPresentationColumns,
  PatchMapHostInstanceComponentPresentationColumns,
  PatchMapHostInstancePresentationColumns,
  PatchMapHostInstanceTextPresentationColumns,
} from './host-contracts';
...
function instanceBarColumns(
  targets: PatchMapHostInstanceBarPresentationColumns['targets'],
  height: PatchMapHostInstanceBarPresentationColumns['height'],
...
function instanceColumns(
  type: 'icon',
  targets: PatchMapHostInstancePresentationColumns['targets'],
  changes: PatchMapUpdateRecord | PatchMapComponentUpdateColumns['changes'] | undefined,
  path: string,
  columnar: boolean,
): PatchMapHostInstancePresentationColumns {
...
function instanceComponentColumns(
  type: 'background',
  targets: PatchMapHostInstanceComponentPresentationColumns['targets'],
...
function instanceTextColumns(
  targets: PatchMapHostInstanceTextPresentationColumns['targets'],
  changes: object | undefined,
