...
function projectHostAdapter(actual, projection) {
  ...
  actual.outcome.restrictedImportCount = nonNegativeInteger(
    adapter.restrictedImportCount,
...
function assert(condition, message) {
  if (!condition) throw new Error(`Invalid PatchMap package fold: ${message}`);
}
