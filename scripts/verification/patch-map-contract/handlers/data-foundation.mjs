 ...
 * source-only TypeScript entry. Node automation can inject the packed PatchMap
...
function constructColorInput(product, descriptor) {
  ...
  throw new Error(`PatchMap data-foundation handler invalid: unsupported color constructor ${constructor}`);
}
...
function assert(condition, message) {
  if (!condition) throw new Error(`PatchMap data-foundation handler invalid: ${message}`);
}
