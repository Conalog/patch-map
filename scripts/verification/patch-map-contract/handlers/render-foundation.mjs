...
function findElement(elements, id) {
  ...
  throw new Error(`PatchMap render-foundation handler invalid: missing element ${id}`);
}
...
function assert(condition, message) {
  if (!condition) throw new Error(`PatchMap render-foundation handler invalid: ${message}`);
}
