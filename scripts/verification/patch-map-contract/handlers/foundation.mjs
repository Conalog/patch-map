...
function backendPreference(value) {
  ...
  throw new Error(`PatchMap foundation handler invalid: unsupported backend ${backend}`);
}
...
function assert(condition, message) {
  if (!condition) throw new Error(`PatchMap foundation handler invalid: ${message}`);
}
