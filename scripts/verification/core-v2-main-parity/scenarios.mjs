...
const PAR_001_ACCEPTED_DIFFERENCES = Object.freeze([
  Object.freeze({
    ...
    reason:
      'Core v2 keeps its approved deterministic text metrics while main uses browser-runtime glyph metrics',
  }),
  Object.freeze({
    checkpoint: '*',
    ...
    reason:
      'main getBounds includes the centered stroke while Core v2 semantic bounds retain the authored frame; pixels include the stroke in both runtimes',
  }),
  Object.freeze({
    checkpoint: 'world-*',
    ...
    classification: 'semantic-vs-painted-stroke-bounds',
    reason:
      'main getBounds includes the background stroke while Core v2 reports its authored component quad',
  }),
  Object.freeze({
    checkpoint: 'world-*',
    ...
    reason:
      'Core v2 preserves the approved authored icon center during readable half-turn correction while main rotates the placement around the owner center',
  }),
  Object.freeze({
    checkpoint: 'world-*',
    ...
    classification: 'approved-authored-center-orientation',
    reason:
      'the icon pixels follow Core v2 authored-center orientation rather than main placement rotation',
  }),
]);
...
const PAR_002_ACCEPTED_DIFFERENCES = Object.freeze([
  Object.freeze({
    ...
    reason:
      'Core v2 keeps an upright bottom bar on the visible bottom after reflection as explicitly approved; main leaves it on the opposite visual edge',
  }),
  Object.freeze({
    checkpoint: 'world-180-ny',
  ...
  Object.freeze({
    ...
    reason:
      'Core v2 uses the approved F×R screen-axis reflection order while main black-box behavior composes the reflected rotation differently',
  }),
  Object.freeze({
    checkpoint: 'world-315-xn',
    ...
    classification: 'approved-screen-axis-affine-order',
    reason:
      'the whole-scene image envelope follows the approved Core v2 F×R screen-axis reflection order',
  }),
  Object.freeze({
    checkpoint: 'world-315-xn',
    path: 'image.entity.*',
    classification: 'approved-screen-axis-affine-order',
    reason:
      'leaf pixels follow the approved Core v2 F×R screen-axis reflection order',
  }),
]);
...
const PAR_005_ACCEPTED_DIFFERENCES = Object.freeze([
  ...
  Object.freeze({
    ...
    reason:
      'Core v2 honors the approved show:false update while main leaves the standalone rect visible',
  }),
]);
...
const PAR_007_ACCEPTED_DIFFERENCES = Object.freeze([
  Object.freeze({
    ...
    classification: 'semantic-vs-painted-stroke-bounds',
    reason:
      'main getBounds includes the centered stroke while Core v2 semantic bounds retain the authored transformer frame',
  }),
  Object.freeze({
    checkpoint: '*',
    path: 'image.content.bounds',
...
const PAR_010_ACCEPTED_DIFFERENCES = Object.freeze([
  Object.freeze({
    ...
    reason:
      'Core v2 preserves the declared world center across host resize, as pinned by LIF-004/VIE-007, while main keeps the prior top-left screen mapping',
  }),
  Object.freeze({
    checkpoint: 'resize-*',
    path: 'entity.*.bounds.*',
    classification: 'approved-center-preserving-resize',
    reason:
      'entity screen placement follows Core v2 world-center preservation after the host aspect ratio changes',
  }),
  Object.freeze({
    checkpoint: 'resize-*',
    path: 'image.content.bounds',
    classification: 'approved-center-preserving-resize',
    reason:
      'the raster envelope follows Core v2 world-center preservation after resize',
  }),
  Object.freeze({
    checkpoint: 'resize-*',
    path: 'image.entity.*',
    classification: 'approved-center-preserving-resize',
    reason:
      'isolated entity pixels follow Core v2 world-center preservation after resize',
  }),
]);
...
const PAR_013_ACCEPTED_DIFFERENCES = Object.freeze([
  ...[
    ...
    reason:
      'main may physically remove a hidden component from its public selector while Core v2 intentionally retains aggregate logical identity; the fixed raster strip independently verifies that neither runtime paints it',
  })),
  ...[
    'visibility-background-item::visibility-background',
    'visibility-bar-item::visibility-bar',
    ...
    reason:
      'main keeps the selected component wrapper visible while suppressing its painted child; Core v2 exposes logical visibility directly and the fixed raster strip proves equivalent output',
  })),
  Object.freeze({
    checkpoint: '*',
    ...
    classification: 'approved-pinned-text-metrics',
    reason:
      'Core v2 keeps approved deterministic CJK fallback metrics while main uses browser-runtime glyph metrics',
  }),
  Object.freeze({
    checkpoint: '*',
    path: 'image.content.bounds',
...
const PAR_014_ACCEPTED_DIFFERENCES = Object.freeze([
  Object.freeze({
    ...
    classification: 'approved-pinned-text-metrics',
    reason:
      'Core v2 uses deterministic Latin/CJK metrics and guarded fallback while main uses browser-runtime glyph metrics',
  }),
  Object.freeze({
    checkpoint: '*',
    path: 'image.content.bounds',
...
const PAR_016_ACCEPTED_DIFFERENCES = Object.freeze([
  Object.freeze({
    ...
    reason:
      'main publicly accepts the source update but expands its background bounds with malformed border geometry; Core v2 retains the approved full-item rounded rectangle',
  }),
  Object.freeze({
    checkpoint: 'undo-*',
    path: 'entity.component-style-background-item::component-style-background.bounds.*',
    classification: 'approved-background-geometry-correction',
    reason:
      'the malformed main background remains after undoing a later icon tint while Core v2 retains the approved full-item rounded rectangle',
  }),
  Object.freeze({
    checkpoint: 'redo-*',
    path: 'entity.component-style-background-item::component-style-background.bounds.*',
    classification: 'approved-background-geometry-correction',
    reason:
      'the malformed main background remains after redoing a later icon tint while Core v2 retains the approved full-item rounded rectangle',
  }),
  Object.freeze({
    checkpoint: 'update-component-*',
