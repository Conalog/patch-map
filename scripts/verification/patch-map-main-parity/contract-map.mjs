...
export async function buildPatchMapMainParityContractMap({
  manifestPath,
  typedCasesPath,
  ...
  return Object.freeze({
    schemaRevision: 'patch-map-main-parity-contract-map/2026-07-29.1',
...
function comparisonRationale(mode) {
  switch (mode) {
    ...
    case 'core-contract-extension':
      return 'the approved PatchMap boundary has no equivalent main public behavior and is verified independently';
    case 'consumer-seam':
