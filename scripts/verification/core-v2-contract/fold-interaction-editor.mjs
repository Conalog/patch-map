...
function projectCase(caseId, execution) {
  switch (caseId) {
    ...
    default:
      throw new Error(`Core v2 interaction/editor fold invalid: unsupported case ${caseId}`);
  }
}
...
function assert(condition, message) {
  if (!condition) throw new Error(`Core v2 interaction/editor fold invalid: ${message}`);
}
