...
function validateProductCleanup(value) {
  ...
  assert(cleanup.revision === 'core-v2-ren-005-product-cleanup/1', 'cleanup product revision');
...
function assert(condition, message) {
  if (!condition) throw new Error(`Core v2 render-images fold invalid: ${message}`);
}
