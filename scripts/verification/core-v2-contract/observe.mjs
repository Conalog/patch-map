...
export const SEMANTIC_OBSERVATION_REVISION = 'core-v2-semantic-observation/1';
...
/**
 * Validate and detach an actual-only Core v2 semantic observation.
 *
...
function assert(condition, message) {
  if (!condition) throw new Error(`Core v2 semantic observation invalid: ${message}`);
}
