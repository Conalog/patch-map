import actionSchemaJson from '../../contracts/evidence/catalog-action-schema.v1.json';
import manifestJson from '../../contracts/evidence/catalog-evidence-manifest.v1.json';
import profileJson from '../../contracts/evidence/catalog-fixture-profiles.v1.json';
import fixtureCatalogJson from '../../contracts/evidence/catalog-fixtures.v1.json';
import {
