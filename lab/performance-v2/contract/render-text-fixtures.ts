export const CORE_V2_RENDER_TEXT_SPECIMEN_IDS = Object.freeze([
  'placed',
  'auto',
  'wrap',
  'overflow-visible',
...
export type CoreV2RenderTextSpecimenId =
  (typeof CORE_V2_RENDER_TEXT_SPECIMEN_IDS)[number];

export interface CoreV2RenderTextSpecimen {
  readonly id: CoreV2RenderTextSpecimenId;
 ...
 */
export function createCoreV2RenderTextSpecimens(): readonly CoreV2RenderTextSpecimen[] {
  return deepFreeze([
    specimen('placed', {
...
function specimen(
  id: CoreV2RenderTextSpecimenId,
  input: SpecimenInput,
): CoreV2RenderTextSpecimen {
