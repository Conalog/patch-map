...
export const CORE_V2_EXECUTABLE_COUNT = 135;
export const CORE_V2_CONTRACT_STUB_COUNT = 38;
...
const EXECUTABLE_ACTION_COUNT = 514;
const EXECUTABLE_ACTION_TYPE_COUNT = 286;
