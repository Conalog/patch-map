...
export const CORE_V2_EXECUTABLE_COUNT = 83;
export const CORE_V2_CONTRACT_STUB_COUNT = 90;
...
const EXECUTABLE_ACTION_COUNT = 298;
const EXECUTABLE_ACTION_TYPE_COUNT = 168;
