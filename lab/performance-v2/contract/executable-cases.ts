...
export const CORE_V2_EXECUTABLE_COUNT = 170;
export const CORE_V2_CONTRACT_STUB_COUNT = 3;
...
const EXECUTABLE_ACTION_COUNT = 636;
const EXECUTABLE_ACTION_TYPE_COUNT = 371;
