...
export const CORE_V2_EXECUTABLE_COUNT = 146;
export const CORE_V2_CONTRACT_STUB_COUNT = 27;
...
const EXECUTABLE_ACTION_COUNT = 578;
const EXECUTABLE_ACTION_TYPE_COUNT = 319;
