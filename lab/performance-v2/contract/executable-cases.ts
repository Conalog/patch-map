...
export const CORE_V2_EXECUTABLE_COUNT = 43;
export const CORE_V2_CONTRACT_STUB_COUNT = 130;
...
const EXECUTABLE_ACTION_COUNT = 183;
const EXECUTABLE_ACTION_TYPE_COUNT = 90;
...
invariant(selectedActionCount === EXECUTABLE_ACTION_COUNT, 'executable action count must remain 183');
invariant(
  selectedActionTypes.size === EXECUTABLE_ACTION_TYPE_COUNT,
  'executable action type count must remain 90',
);
