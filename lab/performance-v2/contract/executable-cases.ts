...
export const CORE_V2_EXECUTABLE_COUNT = 42;
export const CORE_V2_CONTRACT_STUB_COUNT = 131;
...
const EXECUTABLE_ACTION_COUNT = 176;
const EXECUTABLE_ACTION_TYPE_COUNT = 86;
...
invariant(selectedActionCount === EXECUTABLE_ACTION_COUNT, 'executable action count must remain 176');
invariant(
  selectedActionTypes.size === EXECUTABLE_ACTION_TYPE_COUNT,
  'executable action type count must remain 86',
);
