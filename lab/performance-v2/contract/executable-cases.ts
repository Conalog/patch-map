...
export const CORE_V2_EXECUTABLE_COUNT = 145;
export const CORE_V2_CONTRACT_STUB_COUNT = 28;
...
const EXECUTABLE_ACTION_COUNT = 573;
const EXECUTABLE_ACTION_TYPE_COUNT = 317;
