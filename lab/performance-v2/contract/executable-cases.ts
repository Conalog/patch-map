...
export const CORE_V2_EXECUTABLE_COUNT = 99;
export const CORE_V2_CONTRACT_STUB_COUNT = 74;
...
const EXECUTABLE_ACTION_COUNT = 361;
const EXECUTABLE_ACTION_TYPE_COUNT = 199;
