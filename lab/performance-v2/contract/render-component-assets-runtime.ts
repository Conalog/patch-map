...
export interface CoreV2RenderComponentAssetsProductAdapter {
...
export interface CoreV2RenderComponentAssetsRuntime {
  readonly assetRuntime: CoreV2AssetRuntime;
  readonly assetPolicy: CoreV2AssetPolicy;
  readonly product: CoreV2RenderComponentAssetsProductAdapter;
 ...
 * exclusively owned by CoreV2Engine public probes.
 */
export function createCoreV2RenderComponentAssetsRuntime(): CoreV2RenderComponentAssetsRuntime {
  ...
  const product: CoreV2RenderComponentAssetsProductAdapter = Object.freeze({
...
class ComponentAssetFixtureBackend implements CoreV2AssetBackend {
...
function registrationsFor(caseId: ComponentAssetCaseId): readonly CoreV2AssetRegistration[] {
...
function fixtureFor(descriptor: CoreV2AssetDescriptor): FixtureDefinition {
  invariant(
...
function invariant(condition: unknown, message: string): asserts condition {
  if (!condition) throw new Error(`Core v2 component-assets runtime invalid: ${message}`);
}
